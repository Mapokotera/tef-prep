  ...
  b2: [
    {
      ...
      vocab: [
        {fr:"accueillir",en:"to welcome / receive",type:"verb"},
        {fr:"le vieillissement",en:"ageing",type:"noun (m)"},
        {fr:"le tissu social",en:"the social fabric",type:"noun (m)"},
        {fr:"la formation linguistique",en:"language training",type:"noun (f)"},
        {fr:"sous pression",en:"under pressure",type:"expression"},
        {fr:"la croissance démographique",en:"population growth",type:"noun (f)"},
        {fr:"les zones métropolitaines",en:"metropolitan areas",type:"noun (f pl)"},
        {fr:"s'élèvent",en:"are raised / arise",type:"verb"},
      ],
      translation: "Canada is one of the countries that welcomes the largest number of immigrants in the world. Each year, the federal government sets ambitious immigration targets to meet labour market needs and offset an ageing population. In 2024, the country aimed to welcome more than 400,000 new permanent residents.\n\nHowever, this policy is not without challenges. Integrating newcomers into the social and economic fabric of the country remains a priority. Language training programmes, particularly in French for candidates wishing to settle in Quebec, are being put in place to ease this transition.\n\nImmigrants contribute significantly to the Canadian economy. They fill positions in sectors facing shortages, such as healthcare, engineering and information technology. Furthermore, the multiculturalism that characterises major cities like Toronto, Vancouver and Montreal is often cited as one of Canada's strengths on the international stage.\n\nNevertheless, voices are calling for better infrastructure planning to absorb this rapid population growth. Housing, public transport and healthcare services are under particular pressure in metropolitan areas.",
      questions: [
    ...
    },
    {
      ...
      vocab: [
        {fr:"le télétravail",en:"remote work / working from home",type:"noun (m)"},
        {fr:"marginal(e)",en:"marginal / minor",type:"adj"},
        {fr:"ancré(e)",en:"embedded / entrenched",type:"adj"},
        {fr:"le secteur tertiaire",en:"the service sector",type:"noun (m)"},
        {fr:"la conciliation",en:"work-life balance / reconciliation",type:"noun (f)"},
        {fr:"l'isolement",en:"isolation",type:"noun (m)"},
        {fr:"l'hyperconnectivité",en:"hyperconnectivity",type:"noun (f)"},
        {fr:"hybride",en:"hybrid",type:"adj"},
      ],
      translation: "Remote working, long a marginal practice in French companies, has seen spectacular growth since the 2020 pandemic. This form of work organisation, which allows employees to carry out their duties from home or any other location away from the office, is now embedded in the professional practices of many organisations.\n\nAccording to a recent survey, almost 40% of French employees now work remotely at least one day a week. Workers in the service sector — IT, finance, communications — are the most affected. Manual occupations and professions providing direct service to the public, however, remain largely incompatible with this practice.\n\nThe advantages of remote working are numerous: reduced commuting time, a better work-life balance, and in some cases increased productivity. However, drawbacks also exist. Social isolation, the difficulty of separating workspace from living space, and the risks of hyperconnectivity are regularly reported by remote workers.\n\nFaced with these findings, many companies are now adopting hybrid arrangements, combining office presence with remote working. This approach aims to make the best of both modalities while preserving team cohesion.",
      questions: [
